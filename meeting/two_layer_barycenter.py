...
def branch_and_cut(bottom_nodes, top_nodes, edges):
    """
    Reorders bottom nodes using the branch-and-cut algorithm.
    ...
    best_order = bottom_nodes
    best_crossings = float('inf')

    # Generate all permutations of bottom nodes
    for perm in permutations(bottom_nodes):
        crossings = cross_count(top_nodes, perm, edges)
