...
def cross_count(fixed_layer: list[str], free_layer: list[str], edges: list, layered_pos_data=None, LA_gen=0) -> int:
    """
    ...
    #     free_layer = [f"u{num}" for num in free_layer]
        ...
        # print("ddebbug crosscount zands", fixed_layer)
    # print("cross zandrew", fixed_layer, free_layer, edges)
    # print("inside cross count zands", fixed_layer, free_layer)
