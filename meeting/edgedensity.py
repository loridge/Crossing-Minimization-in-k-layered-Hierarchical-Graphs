...
def generator_bip_graph(layer1_size, layer2_size, edge_density, LA=0):
    """
    ...
    layer1 = [i for i in range(layer1_size)]
    layer2 = [i + layer1_size for i in range(layer2_size)]
    ...
    for edge in selected_edges:
        edges.append({"nodes": [f'u{edge[0]}', f'u{edge[1]}']})
