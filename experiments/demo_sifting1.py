...
from utility.bipartite_graph_generator import visualize_bipartite_graph, generate_bipartite_graph, update_positions, count_crossings
...
for i in range(n):    
    nodes, edges, B, top_nodes, bottom_nodes = generate_bipartite_graph(20,20,0.3)
